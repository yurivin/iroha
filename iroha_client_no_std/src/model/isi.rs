...
pub mod prelude {
    ...
    pub use crate::model::{account::isi::*, asset::isi::*, domain::isi::*, isi::*, peer::isi::*};
}
...
pub enum Instruction {
    ...
    Peer(crate::model::peer::isi::PeerInstruction),
    /// Instruction variants related to `Domain`.
    Domain(crate::model::domain::isi::DomainInstruction),
    /// Instruction variants related to `Asset`.
    Asset(crate::model::asset::isi::AssetInstruction),
    /// Instruction variants related to `Account`.
    Account(crate::model::account::isi::AccountInstruction),
    /// Instruction variants related to `Permission`.
    Permission(crate::model::permission::isi::PermissionInstruction),
    /// Instruction variants connected to different Iroha Events.
    Event(crate::model::event::isi::EventInstruction),
